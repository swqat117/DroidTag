...
public class BTDeviceSearchView extends RelativeLayout {
     ...
     *                theme, resources, etc.
     */
    public BTDeviceSearchView(Context context) {
        this(context, null, 0);
    }
     ...
     */
    public BTDeviceSearchView(Context context, AttributeSet attrs) {
     ...
     *                     for defaults.
     */
    public BTDeviceSearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        // get attributes
        TypedArray attr = context.getTheme().obtainStyledAttributes(
                attrs, R.styleable.BTDeviceSearchView, 0, 0);
        ...
        try {
            mCount = attr.getInteger(R.styleable.BTDeviceSearchView_pulse_count, DEFAULT_COUNT);
            mDuration = attr.getInteger(R.styleable.BTDeviceSearchView_pulse_duration,
                    DEFAULT_DURATION);
            mRepeat = attr.getInteger(R.styleable.BTDeviceSearchView_pulse_repeat, DEFAULT_REPEAT);
            mStartFromScratch = attr.getBoolean(R.styleable.BTDeviceSearchView_pulse_startFromScratch,
                    DEFAULT_START_FROM_SCRATCH);
            mColor = attr.getColor(R.styleable.BTDeviceSearchView_pulse_color, DEFAULT_COLOR);
            mInterpolator = attr.getInteger(R.styleable.BTDeviceSearchView_pulse_interpolator,
