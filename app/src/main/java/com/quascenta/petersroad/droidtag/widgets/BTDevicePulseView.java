...
public class BTDevicePulseView extends View {
    ...
    public BTDevicePulseView(final Context context) {
        this(context, null);
    }

    public BTDevicePulseView(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BTDevicePulseView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
