...
public class GenreDataFactory {
    ...
    public static Genre makeJazzGenre() {
        return new Genre("Jazz", makeJazzArtists(), R.drawable.ic_saxophone);
    }
    ...
    public static SingleCheckGenre makeSingleCheckJazzGenre() {
        return new SingleCheckGenre("Jazz", makeJazzArtists(), R.drawable.ic_saxophone);
    }
    ...
    public static Genre makeSalsaGenre() {
        return new Genre("Salsa", makeSalsaArtists(), R.drawable.ic_saxophone);
    }

    public static MultiCheckGenre makeMultiCheckSalsaGenre() {
        return new MultiCheckGenre("Salsa", makeSalsaArtists(), R.drawable.ic_saxophone);
    }

    public static SingleCheckGenre makeSingleCheckSalsaGenre() {
        return new SingleCheckGenre("Salsa", makeSalsaArtists(), R.drawable.ic_saxophone);
    }
    ...
    public static Genre makeBluegrassGenre() {
        return new Genre("Bluegrass", makeBluegrassArtists(), R.drawable.ic_saxophone);
    }

    public static MultiCheckGenre makeMulitCheckBluegrassGenre() {
        return new MultiCheckGenre("Bluegrass", makeBluegrassArtists(), R.drawable.ic_saxophone);
    }

    public static SingleCheckGenre makeSingleCheckBluegrassGenre() {
        return new SingleCheckGenre("Bluegrass", makeBluegrassArtists(), R.drawable.ic_saxophone);
    }
