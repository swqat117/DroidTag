...
public class CurvedImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (styledAttributes.hasValue(R.styleable.CurvedImageView_tintAlpha)) {
            if (styledAttributes.getInt(R.styleable.CurvedImageView_tintAlpha, 0) <= 255
                    && styledAttributes.getInt(R.styleable.CurvedImageView_tintAlpha, 0) >= 0) {
                tintAmount = styledAttributes.getInt(R.styleable.CurvedImageView_tintAlpha, 0);
            }
        }
        ...
        if (styledAttributes.hasValue(R.styleable.CurvedImageView_tintMode)) {
            if (styledAttributes.getInt(R.styleable.CurvedImageView_tintMode, 0) == TintMode.AUTOMATIC) {
        ...
        if (styledAttributes.hasValue(R.styleable.CurvedImageView_tintColor)) {
            tintColor = styledAttributes.getColor(R.styleable.CurvedImageView_tintColor, 0);
        }
