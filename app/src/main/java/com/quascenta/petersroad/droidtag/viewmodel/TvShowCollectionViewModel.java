...
public class TvShowCollectionViewModel implements AdapteeCollection<TvShowViewModel>{
  ...
  @Override
  public boolean add(TvShowViewModel element) {
   if(element != null) {
     tvShows.add(element);
     return true;
   }
  ...
  @Override
  public boolean addAll(Collection<? extends TvShowViewModel> elements) {
    tvShows.addAll(elements);
    return true;
  }
  ...
  @Override
  public TvShowViewModel get(int index) {
    return tvShows.get(index);
  }

  @Override
  public boolean remove(Object element) {
    tvShows.remove(element);
    return true;
  }
